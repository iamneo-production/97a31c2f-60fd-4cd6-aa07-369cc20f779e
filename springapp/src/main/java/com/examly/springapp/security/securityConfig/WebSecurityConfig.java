...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
		http.cors().and().csrf().disable()
			...
			.antMatchers("/admin/addInstitute/**","/admin/editInstitute/*","/admin/viewInstitutes","/admin/deleteInstitutes","/admin/viewCourse","/admin/editCourse/*","/admin/addCourse/**","/admin/deleteCourse/*").permitAll()
			.antMatchers("/admin/addInstitute/**","/admin/editInstitute/*","/admin/viewInstitutes","/admin/deleteInstitutes","/admin/viewCourse/**","/admin/addStudent/**").permitAll()
